...
The physics, inverse-kinematics math, and Arduino firmware/emulation were developed together with **Armando Rodriguez** ([@armandorodb](https://github.com/armandorodb)), robotics engineer. See the top-level [`README.md`](../README.md#acknowledgments).
